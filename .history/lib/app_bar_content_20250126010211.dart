...
enum PressedButton { none, careers, about, login, register }
...
class _AppBarContentState extends State<AppBarContent> {
  PressedButton _pressedButton = PressedButton.PressedButton.none
      ...
      children: [
        ...
        TextButton(
          ...
          child: Text(
            ...
            style: GoogleFonts.epilogue(
              fontSize: 13,
              fontWeight: _pressedButton == PressedButton.careers ? FontWeight.bold : FontWeight.normal,
              color: AppColors.mediumGray,
            ),
          ),
        ),
        ...
        TextButton(
          ...
          child: Text(
            ...
            style: GoogleFonts.epilogue(
              fontSize: 13,
              fontWeight: _pressedButton == PressedButton.about ? FontWeight.bold : FontWeight.normal,
              color: AppColors.mediumGray,
            ),
          ),
        ),
        ...
        TextButton(
          ...
          child: Text(
            ...
            style: GoogleFonts.epilogue(
              fontSize: 13,
              fontWeight: _pressedButton == PressedButton.login ? FontWeight.bold : FontWeight.normal,
              color: AppColors.mediumGray,
            ),
          ),
        ),
        Padding(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              foregroundColor: _pressedButton == PressedButton.register ? AppColors.almostBlack : Colors.grey[800],
            ...
            child: Text(
              ...
              style: GoogleFonts.epilogue(
                fontSize: 13,
                color: _pressedButton == PressedButton.register ? AppColors.almostBlack : Colors.grey[800],
              ),
            ),
          ),
        ),
